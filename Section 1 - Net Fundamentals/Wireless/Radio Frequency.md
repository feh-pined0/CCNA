Radio frequencies are used to send wireless signals. These frequencies are created by applying an alternating current to an antenna, which creates electromagnetic fields that propagate as waves.
