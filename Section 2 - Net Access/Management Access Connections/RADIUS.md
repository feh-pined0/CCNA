*Remote Authentication Dial-In User Service* is a network protocol that is used to authenticate network users and authorize network traffic (such as network access and network device access).
